...
| **02** | `02_entity_and_dto` *(예정)* | • DDD 스타일 도메인 엔티티 (정적 팩토리 `newInstance`, 불변성)<br>• `Command` / `Result` 패턴 (계층 간 데이터 전송 규격)<br>• `@Valid` 요청 값 유효성 검증 | • [`user/entity/User.java`](../atworks-lithium/src/main/java/com/apitest/atworks/user/entity/User.java)<br>• [`user/service/UserService.java`](../atworks-lithium/src/main/java/com/apitest/atworks/user/service/UserService.java)<br>• [`project/controller/request`](../atworks-lithium/src/main/java/com/apitest/atworks/project/controller/request) |
